...
//	env +=    "Total   Memory:          " + TOT_MEM + "\r\n";
	...
	env += "\r\n";
	env +=	  "Status Symbols           ";
	env += FinalCrypt.UTF8_SUCCEEDED_DESC + ": " +	    FinalCrypt.UTF8_SUCCEEDED_SYMBOL + " ";
	env += FinalCrypt.UTF8_SUCCESSUNKNOWN_DESC + ": " +	    FinalCrypt.UTF8_SUCCESSUNKNOWN_SYMBOL + " ";
	env += FinalCrypt.UTF8_UNSUCCEEDED_DESC + ": " +	    FinalCrypt.UTF8_UNSUCCEEDED_SYMBOL + " ";
